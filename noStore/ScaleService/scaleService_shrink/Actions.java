...
public class Actions
{
	...
	public int test(TestCaseConfig cass) throws Exception{
		...
		return doTest( cass.getId() ,  cass.getUrl(),validate ,  cass.getOpts() ) ;
    }
	...
	public int doTest(String id,String url,TestCaseValidater validate, Object ...opts) throws Exception{
		  int _ret= SUCC;
		 //  {
		//		    ret:boolean
		//		    error:string
...
//			System.out.println(resulting);
			...
			TestItems item = new TestItems();
//			TestItemsTwo itemTwo = new TestItemsTwo();
			TestReplicas replicas = new TestReplicas();
...
//    	}
 ...
 class TestCaseConfig{
	...
	public TestCaseConfig(String id ,String url,int order){
		this.id = id ;
		this.url = url ;
		this.order = order ;
	}
	
	public TestCaseConfig(String id ,String url){
		this(  id ,  url, -1) ;
	}
